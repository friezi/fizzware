...
*/
#ifndef FZTOOLTEMPL_LEX_HPP
#define FZTOOLTEMPL_LEX_HPP
...
namespace parse{
  ...
  */
  ...
  public:
    ...
    LexScreener(std::istream * input, LexCharClasses * char_classes) throw (exc::Exception<LexScreener>);
...
//     void setLexCharClasses(LexCharClasses * char_classes){ this->char_classes = char_classes; }
  ...
  */
  ...
  public:
    ...
    */
    LexScanner(std::istream * input) throw (exc::Exception<LexScreener>, exc::ExceptionBase);
    ...
    */
    int nextToken() throw (exc::Exception<LexScanner>);
